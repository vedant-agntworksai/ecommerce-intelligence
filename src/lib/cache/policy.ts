export type ResourceKind =
  ...
  | "availability" | "rating" | "review_count" | "competitor_relationship" | "retailer_search";
...
export function isFresh(updatedAt: Date | string | null | undefined, kind: ResourceKind, ttl = DEFAULT_TTLS_MS[kind]) {
